window.QUOTEFEED_CONFIG = {
  ...
  GAS_ENDPOINT: "https://script.google.com/macros/s/AKfycbwDpdtvBYaGU7r_6QacULV-XT0yygZmjIgrjM7J0U0uadtorbzNsDeyvzkfsgDDkUUnuQ/exec",
  PAGE_SIZE: 12,
  MAX_FILE_BYTES: 50 * 1024 * 1024,

  THEMES: ["ocean","sunset","forest","violet","mono","neon","crimson","gold"],
  FONTS: ["inter","outfit","manrope","rubik"],

  SITE_BASE_URL: location.origin + location.pathname,
};
